...
def consensus(candidates: tuple[RecognitionCandidate, ...], threshold: float = 0.82) -> ConsensusResult:
    ...
    accepted = len(valid) == 1 and best.confidence >= 0.90 or agreement >= 0.66 and confidence >= 0.70
