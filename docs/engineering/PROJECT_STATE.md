...
- Status: Text/photo/PDF document pipeline implemented; repository CI green; live verification pending
...
- Added secure document intelligence for PDF and image documents: bounded download, PDF signature/page/pixel/text limits, per-page text preservation, page rendering and optional OCR.
- Fixed the document extraction regression that previously mapped PDF text incorrectly and contained invalid source syntax.
...
- CI run 35629680260 / CI #258 passed Ruff lint, Ruff format, mypy, and pytest on Python 3.11 and 3.12 after the document/OCR hardening.
- CI run 35629310020 / CI #257 was superseded during diagnosis; its remaining failures were resolved before #258.
